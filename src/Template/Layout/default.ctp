		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbar-ex-collapse">
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li>
					<?php
					echo $this->Html->link ( '<i class="fa fa-home fa-lg"></i>' . ' Home', ($this->fetch ( 'title' ) === 'home') ? '#home' : '/#home', 
							array ('escape' => false,'id' => 'home-link') );
					?>
					</li>
					<li>
					<?php
					echo $this->Html->link ( '<i class="fa fa-lg fa-list-alt"></i>' . ' Programa', ($this->fetch ( 'title' ) === 'home') ? '#program' : '/#program', 
							array ('escape' => false, 'id' => 'program-link'));
					?>
					</li>
					<li>
					<?php
					echo $this->Html->link ( '<i class="fa fa-book fa-lg"></i>' . ' Mostra Acadêmica', ($this->fetch ( 'title' ) === 'home') ? '#academic' : '/#academic', 
							array ('escape' => false, 'id' => 'academic-link'));
					?>
					</li>
					
					<li>
					<?php
					echo $this->Html->link ( '<i class="fa fa-lg fa-map-marker"></i>' . ' Local', ($this->fetch ( 'title' ) === 'home') ? '#where' : '/#where', 
							array ('escape' => false, 'id' => 'where-link'));
					?>
					</li>
					<li>
					<?php
					echo $this->Html->link ( '<i class="fa fa-group fa-lg"></i>' . ' Organização', ($this->fetch ( 'title' ) === 'home') ? '#people' : '/#people', 
							array ('escape' => false, 'id' => 'people-link'));
					?>
					</li>
